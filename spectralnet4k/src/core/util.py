...
def get_accuracy(cluster_assignments, y_true, n_clusters):
    ...
    returns:    a tuple containing the accuracy and confusion matrix,
                in that order
    '''
    y_pred, confusion_matrix, confusion_matrix1= get_y_preds(cluster_assignments, y_true, n_clusters)
    # calculate the accuracy
    return np.mean(y_pred == y_true), confusion_matrix, confusion_matrix1
...
def print_accuracy(cluster_assignments, y_true, n_clusters, extra_identifier=''):
    ...
    '''
    # get accuracy
    accuracy, confusion_matrix, confusion_matrix1= get_accuracy(cluster_assignments, y_true, n_clusters)
    # get the confusion matrix
    print('confusion matrix{}: '.format(extra_identifier))
    print(confusion_matrix)
    print('confusion matrix1{}: '.format(extra_identifier))
...
def get_y_preds(cluster_assignments, y_true, n_clusters):
    ...
    confusion_matrix1 = sklearn.metrics.confusion_matrix(y_true, y_pred, labels=None)
    return y_pred, confusion_matrix, confusion_matrix1
